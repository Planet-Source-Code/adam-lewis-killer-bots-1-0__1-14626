...
Begin VB.Form player 
   ...
   Begin VB.Frame Frame5 
      ...
      Begin VB.ComboBox team 
         ...
         ForeColor       =   &H000000C0&
         Height          =   315
         ItemData        =   "player1.frx":0000
         Left            =   120
         List            =   "player1.frx":000D
         TabIndex        =   9
         Text            =   "Choose One"
         Top             =   360
         Width           =   2415
   ...
   Begin VB.Frame Frame4 
      ...
      Begin VB.ComboBox body 
         ...
         ForeColor       =   &H000000C0&
         Height          =   315
         ItemData        =   "player1.frx":002D
         Left            =   120
         List            =   "player1.frx":003A
         TabIndex        =   7
         Text            =   "Choose One"
         Top             =   360
         Width           =   2415
   ...
   Begin VB.Frame Frame3 
      ...
      Begin VB.ComboBox head 
         ...
         ForeColor       =   &H000000C0&
         Height          =   315
         ItemData        =   "player1.frx":0051
         Left            =   120
         List            =   "player1.frx":005E
         TabIndex        =   5
         Text            =   "Choose One"
         Top             =   360
         Width           =   2415
   ...
   Begin VB.Frame Frame2 
      ...
      Begin VB.ComboBox leg 
         ...
         ForeColor       =   &H000000C0&
         Height          =   315
         ItemData        =   "player1.frx":0085
         Left            =   120
         List            =   "player1.frx":0095
         TabIndex        =   3
         Text            =   "Choose One"
         Top             =   360
         Width           =   2415
   ...
   Begin VB.Frame Frame1 
      ...
      Begin VB.ComboBox arm 
         ...
         ForeColor       =   &H000000C0&
         Height          =   315
         ItemData        =   "player1.frx":00B6
         Left            =   120
         List            =   "player1.frx":00CC
         TabIndex        =   1
         Text            =   "Choose One"
         Top             =   360
         Width           =   2415

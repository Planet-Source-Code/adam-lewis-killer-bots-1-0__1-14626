...
Begin VB.Form player 
   ...
   Begin VB.Frame Frame8 
      ...
      Begin VB.CommandButton Command1 
         ...
         Width           =   615
      End
      Begin MSComctlLib.ProgressBar money 
         Height          =   255
         Left            =   720
         TabIndex        =   49
         Top             =   1320
   ...
   Begin VB.Frame Frame6 
      ...
      Begin VB.Frame Frame10 
         ...
         Top             =   960
         Width           =   5895
         Begin MSComctlLib.ProgressBar cost 
            Height          =   255
            Left            =   600
            TabIndex        =   48
            Top             =   960
   ...
   Begin VB.Frame Frame5 
      ...
      Begin VB.ComboBox team 
         ...
         ForeColor       =   &H000000C0&
         Height          =   315
         ItemData        =   "player.frx":0000
         Left            =   120
         List            =   "player.frx":000D
         TabIndex        =   9
         Text            =   "Choose One"
         Top             =   360
         Width           =   2415
   ...
   Begin VB.Frame Frame4 
      ...
      Begin VB.ComboBox body 
         ...
         ForeColor       =   &H000000C0&
         Height          =   315
         ItemData        =   "player.frx":002D
         Left            =   120
         List            =   "player.frx":003A
         TabIndex        =   7
         Text            =   "Choose One"
         Top             =   360
         Width           =   2415
   ...
   Begin VB.Frame Frame3 
      ...
      Begin VB.ComboBox head 
         ...
         ForeColor       =   &H000000C0&
         Height          =   315
         ItemData        =   "player.frx":0051
         Left            =   120
         List            =   "player.frx":005E
         TabIndex        =   5
         Text            =   "Choose One"
         Top             =   360
         Width           =   2415
   ...
   Begin VB.Frame Frame2 
      ...
      Begin VB.ComboBox leg 
         ...
         ForeColor       =   &H000000C0&
         Height          =   315
         ItemData        =   "player.frx":0085
         Left            =   120
         List            =   "player.frx":0095
         TabIndex        =   3
         Text            =   "Choose One"
         Top             =   360
         Width           =   2415
   ...
   Begin VB.Frame Frame1 
      ...
      Begin VB.ComboBox arm 
         ...
         ForeColor       =   &H000000C0&
         Height          =   315
         ItemData        =   "player.frx":00B6
         Left            =   120
         List            =   "player.frx":00CC
         TabIndex        =   1
         Text            =   "Choose One"
         Top             =   360
         Width           =   2415
